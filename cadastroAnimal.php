        ...
        <div class="u-align-center u-form u-form-1">
          <form action="AnimalInsert.php" method="post" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="marcarConsulta" style="padding: 12px;">
            <div class="u-form-email u-form-group u-label-top">
              ...
              <input type="email" id="email-50d6" name="txtNomeAnimal" class="u-border-3 u-border-palette-4-base u-input u-input-rectangle u-palette-4-light-3 u-radius-25 u-input-1" required="" autofocus="autofocus">
            </div>
