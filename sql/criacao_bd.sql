...
CREATE TABLE saclive.registro(id_registro INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE saclive.consulta(id_consulta INTEGER AUTO_INCREMENT PRIMARY KEY, 
